...
INSERT INTO cr_person (sur_name, given_name, patronymic, date_of_birth,
                       passport_seria, passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Васильева', 'Александр', 'Павловна', '2018-10-24', null, null, null, '321654', '2018-11-09');
...
INSERT INTO cr_address_person (address_id, person_id, start_date, end_data, temporal)
VALUES (1, 1, '2014-10-12', null, false);

INSERT INTO cr_address_person (address_id, person_id, start_date, end_data, temporal)
VALUES (2, 2, '2014-10-12', null, false);

INSERT INTO cr_address_person (address_id, person_id, start_date, end_data)
